...
class AST:
    def __init__(self, allowed_functions, allowed_terminals,
                 prob_terminal=0.3):
        # las funciones (nodos en nuestro caso) que nuestro programa puede
        # tener
        ...
        # de que, a pesar de que ahora toque hacer otro sub arbol, que se
        # ignore eso y se ponga un terminal en su lugar.
    ...
    def __call__(self, max_depth=10):
        ...
        def create_rec_tree(depth):
            ...
            if depth > 0:
                ...
                # alguno de los terminales permitidos que definimos
                # inicialmente
                return TerminalNode(random.choice(self.terminals))

        # llamamos a la funcion auxiliar para crear un arbol de
